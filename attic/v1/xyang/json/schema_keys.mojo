...
## JSON Schema primitive/structural type names.
comptime JSON_SCHEMA_TYPE_OBJECT = "object"
comptime JSON_SCHEMA_TYPE_STRING = "string"
comptime JSON_SCHEMA_TYPE_ARRAY = "array"
comptime JSON_SCHEMA_TYPE_BOOLEAN = "boolean"
comptime JSON_SCHEMA_TYPE_INTEGER = "integer"
comptime JSON_SCHEMA_TYPE_NUMBER = "number"
comptime JSON_SCHEMA_TYPE_NULL = "null"

comptime XYANG_TYPE = "type"
comptime XYANG_PATH = "path"
comptime XYANG_FRACTION_DIGITS = "fraction-digits"
comptime XYANG_BASE = "base"
comptime XYANG_BASES = "bases"
comptime XYANG_BITS = "bits"
comptime XYANG_IF_FEATURES = "if-features"
...
## Round-trip for `type string` with multiple `pattern` / `invert-match` (RFC 7950).
comptime XYANG_STRING_PATTERNS = "string-patterns"
comptime XYANG_STRING_PATTERN_ENTRY_PATTERN = "pattern"
comptime XYANG_STRING_PATTERN_ENTRY_INVERT = "invert-match"
